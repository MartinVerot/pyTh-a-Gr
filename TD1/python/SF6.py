...
button(text='sigmad', bind=showsigma)
...
S = sphere(pos=vector(0,0,0),color=color.yellow )
H1=sphere(pos=vector(0,1,0),radius=0.5)
H2=sphere(pos=vector(0,-1,0),radius=0.5)
H3=sphere(pos=vector(-1,0,0),radius=0.5)
H4=sphere(pos=vector(1,0,0),radius=0.5)
H5=sphere(pos=vector(0,0,1),radius=0.5)
H6=sphere(pos=vector(0,0,-1),radius=0.5)
